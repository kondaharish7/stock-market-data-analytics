...
def save_df_to_s3(Sector, stock_ltp_list) -> None:
    ...
    df_stocks_ltp = df_stocks_ltp[['Sector', 'Industry', 'stock_name', 'nseasondate', 'nsecp', 'nse_change', 'nse_change_%', 'bseasondate', 'bsecp', 'bse_change', 'bse_change_%', 'etl_insert_dt']]
